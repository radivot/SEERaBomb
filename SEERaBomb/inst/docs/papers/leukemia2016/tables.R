...
if (1) {
  ...
  gtot=sum(Total)
  D=data.frame(year=c(1973:2015,NA),as.data.frame(rbind(yrca,Total)),total=c(yrTot,gtot),PY=cf(c(PY,sum(PY))))
  ...
  D=as.data.frame(cbind(year=c(1973:2015,NA),rbind(yrh3,total)))
