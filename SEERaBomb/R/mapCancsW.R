mapCancsW<-function(D){
  ...
  ### these 3 in Prim not here
  # cancer[(who>=470)&(who<=479)]="nerves"
  # cancer[(who>=480)&(who<=489)]="retro"
  # cancer[(who>=490)&(who<=499)]="connect"
  
  ### head and neck of ICD9 lost in prim and here
  ...
  cancer[who==75]="CLL"
  cancer[who==77]="AML"
  cancer[who==78]="CMLw"  # see what is left behind
  cancer[who==80]="AMoL"
  cancer[(who==76)|(who==83)|(who==89)]="OL"  # other leukemia = acute myeloid or lymphoid 
  cancer[who==85]="subLeu"  # MDS and MPN combined?
  
  ##### a few here I'm not willing to give up
